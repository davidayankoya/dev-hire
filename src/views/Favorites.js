...
function Favorites() {
  ...
  return (
    <Wrapper>
      ...
      {freelancersLoading ? (
        <img src={LoadingGif} alt="loading gif" width={100} height={100}></img>
      ) : (
        <ProfilesWrapper>
          {favoriteFreelancers.length < 1 ? <DefaultText><p>Like a freelancer? <span>Add </span>them to your favorites!</p></DefaultText> : 
